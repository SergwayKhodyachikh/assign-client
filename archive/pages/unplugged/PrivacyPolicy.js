...
const PrivacyPolicy = () => {
  return (
    <div>
      Assign's Privacy Notices
Assign provides cloud computing and platform-virtualization services, enabling its enterprise customers to securely connect, manage and automate their digital infrastructures. The following Privacy Notices described how personal information may be collected, used, shared to stored by the different teams in Assign.
...
Assign GLOBAL PRIVACY NOTICE
Assign, Inc., headquartered in the U.S., and its group companies, a part of the Dell Family ("Assign", "we", "us" and "our") are committed to protecting the privacy of individuals who interact with us, such as our website visitors, customers, business partners, leads and prospects, recipients of marketing communications, end users and event attendees ("you" and "your"). This Privacy Notice generally explains the different ways in which Assign collects, uses and shares personal information when:

You visit, interact with or use any of our websites, social media pages, Assign mobile apps (where linked to this Privacy Notice), online advertisements, marketing or sales communications (our "online Properties");
...
You purchase and use Assign products and services (including mobile apps) that have been deployed by one of our business customers, such as your employer (our "Services").
When we mean to refer to any combination of the above, we use the term "Properties".


This Notice does not generally cover the personal information we automatically collect in connection with your use of the Assign Services. For further details regarding the information collected and used by Assign in connection with the provision of the Services, see the Assign Products and Services Notice.


In connection with the provision of specific Properties, Assign may provide additional "just-in-time" disclosures or additional information about our data collection, use and sharing practices. These notices may supplement this Privacy Notice or clarify Assign's privacy practices in the circumstances described or may provide you with additional choices about how Assign processes your data.

If you have any questions about this Privacy Notice, please contact us at privacy@Assign.com.

CONTENTS
PART I: WHAT INFORMATION WE COLLECT & HOW WE COLLECT IT 
"Personal information" is information that identifies an individual or relates to an identifiable individual. Assign and third party service providers collect personal information and other information from various sources which generally fall into the following categories:

Information you provide to us through your interactions with us and your use of the Properties
Information we automatically collect from you in connection with your use of online Properties (see the Assign Products and Services Notice for information we automatically collect in connection with the Services)
...
We will collect personal information when you voluntarily provide it to us (including to our service providers or other parties who collect it on our behalf). For example, we collect personal information when you order, register for (or to use) or request information about Assign products, services or apps, subscribe to marketing communications, request support, complete surveys, provide in product feedback, or sign up for a Assign event or webinar. We may also collect personal information from you offline, such as when you attend one of our events, during phone calls with sales representatives, or when you contact customer support.
...
When making a purchase from Assign, we may also collect billing and transactional information.

Information we automatically collect

Assign collects information from the use of technologies such as cookies, pixel tags, widgets, embedded URLs, electronic communication protocols, buttons and tools in connection with its online Properties. The types of technology used by Assign may change over time as technology evolves. This Privacy Notice and our Cookie Notice provide information about our use of cookies and other similar tracking technologies.
...
Assign Services:
In connection with your organization's deployment of certain Services, Assign may automatically collect information in relation to your use of the Services. See the Assign Products and Services Notice for more information regarding the types of data collected and used in connection with Assign’s provision of the Services.

If you are an individual user of Assign Services and you require more information regarding our data collection practices for Services deployed by your organization, please contact your IT administrator.

Information from third party sources and affiliated companies

From time to time, we may obtain information about you from third party sources unless prohibited by applicable law, such as public databases, resellers and channel partners, marketing partners, social media platforms, event organizers or other publicly available information. We may also obtain information about you from our affiliated companies, including Dell Technologies, Dell EMC, Pivotal, RSA, SecureWorks and VirtuStream (the "Dell Family") and, to the extent involved in the sales and marketing of our collective products and services, their appointed partners

Examples of the information we may receive from other sources include: name, address, telephone number, office location, approximate location (based on reverse IP lookup), account information, job role and publicly available employment profile, service and support information, information about your product or service interests or preferences, browsing habits, page-view information from some business partners with which we operate co-branded services or joint offerings, and credit history information from credit bureaus. We may use this information in conjunction with your contact details, professional information and Assign transaction history for the purposes set forth in this Privacy Notice, such as, for example, improving the accuracy of our records, better understanding you and your preferences, providing relevant marketing and support, and detecting and preventing fraud.

PART II: HOW WE USE YOUR INFORMATION 
Assign uses personal information it collects for the following purposes (unless otherwise restricted by applicable law). For information on how Assign shares personal information, see Part III.

Communicate, Respond to Requests and Engage in/Process Transactions:: Assign may use personal information to communicate with you, respond to your requests or provide information requested by you. Assign may also use personal information, including financial, credit card and payment information, to process your transactions.

Facilitate the Delivery of the Service and Account Administration: Assign may use personal information to provide you with the Services, to manage your account, and to communicate with you about your use of our Services. This may include managing product downloads, updates and fixes, providing support and recommendations, and sending other administrative or account-related communications, including release notes. Assign will also use personal information to facilitate the delivery of the Services and this may include tracking entitlements, verifying compliance, controlling access to the Service, and maintaining the security and operational integrity of the Assign IT infrastructure and our Services. See the Assign Products and Services Notice for details regarding the information Assign collects in connection with your use of the Services and in order to operate the Service.

Facilitate and Evaluate Use of the Online Properties: Assign may use personal information to provide you with the online Properties, to facilitate your use of the online Properties (such as facilitating navigation and the login process, preserving information between sessions and enhancing security), to improve quality, to evaluate page response rates and personalize and determine content.

Improve our Properties: Assign uses personal information and other data Assign collects from you to better understand our customers, users and website visitors and the way they use and interact with the Properties, including their user experience. Assign uses this information to provide a personalized experience, to implement the preferences you request, to improve quality and reliability, to diagnose issues with and improve the Properties and related user experiences, and to make recommendations.
...
Provide Support: Assign uses personal information and other data Assign collects from you, in combination with other data we may have, in order to provide you with support in relation to our Properties.

Post Testimonials: Assign may use personal information to post testimonials on its Online Properties. Prior to posting a testimonial, we will obtain your consent to use your name and testimonial. You can request your testimonial be updated or deleted at any time by sending a request with your name, testimonial location and contact information.

Marketing: Assign will use information it obtains from you, your interactions with Assign over time and across the Properties, and from third party sources to provide you with marketing and promotional communications, to deliver targeted and relevant advertising and marketing to you, to determine the effectiveness of our marketing and promotional campaigns, to better understand you and your preferences, and to position and promote our products and services. Our marketing will be conducted in accordance with your advertising / marketing preferences and as permitted by applicable law.

Security: Assign may use personal information to help monitor, prevent and detect fraud, enhance security, monitor and verify identity or access, and combat spam or other malware or security risks.

Quality Control and Training: Assign may use or access personal data for the purposes of quality control related to the Properties and staff training.

Third Party Social Networks: Assign may use personal information to interact with you on third party social networks (subject to that network's terms of use).

Conferences and Events: Assign and our partners may use personal information to communicate with you about our events or our partner events. After the event, Assign may contact you about the event and related products and services, and may share information about your attendance with your company and our conference sponsors and partners, where legally permitted to do so. If a partner or conference sponsor directly requests your personal information at their conference booths or presentations, your personal information will be handled in accordance with their privacy practices. We recommend that you review the privacy practices of such partners and sponsors.

Provide Online Communities and Blogs: We may use personal information and other information disclosed by you on our message boards, chat features, blogs and other services or platforms to which you are able to post information and materials for the purposes of providing you and our customers with a forum to discuss Assign Properties, responding to your request, providing you with support, improving our Properties or any other purposes set forth in this Privacy Notice. Any information that is disclosed in those forums becomes public information and may therefore appear in public ways, such as through search engines or other publicly available platforms, and may be “crawled” or searched by third parties. It could also be read, collected or used by other users to send you unsolicited messages. Please do not post any information that you do not want to reveal to the public at large.

Education and Training: If you sign up for a Assign certification course or seminar, Assign will use your personal information to facilitate the delivery of such course or seminar. To the extent your organization has paid for your certification course or seminar, Assign may provide the status of your course or seminar to your organization upon notice to you.

Protect our Employees and Facilities: Assign may use personal information as necessary to protect the health and safety of our employees and visitors, our facilities and our property and other rights. If you visit one of our sites, you may be photographed or videotaped as part of maintaining the security of such sites.

Other Legitimate Business Purposes: We may use your personal information when it is necessary for other legitimate purposes such as protecting Assign's confidential and proprietary information.
...
Assign maintains (and requires its service providers to maintain) appropriate organizational and technical measures designed to protect the security and confidentiality of any personal information we process. For example, Assign employs physical access controls, encryption, Internet firewalls, intrusion detection and network monitoring depending on the nature of the information and the scope of processing. Assign staff who may have access to personal information are required to keep that information confidential. However, no security procedures or protocols are ever guaranteed to be 100% secure and so we encourage you to take care when disclosing personal information online and to use readily available tools, such as Internet firewalls, anti-virus and anti-spyware software, and similar technologies to protect yourself online.

PART VI: YOUR PRIVACY RIGHTS AND CHOICES 
Right to Correct or Update Your Information: If you would like to correct or update personal information that you have provided to us, please logon to myAssign.com and update your profile.

 

Marketing Communications: You can opt-out of receiving marketing communications from Assign by going to the Assign Subscription Center and unsubscribing. You can opt-out of receiving marketing communications from Carbon Black by going to the Carbon Black Preference Center and unsubscribing.
...
Right to object to processing: You may have the right to request that Assign stop processing your personal information and/or to stop sending you marketing communications.
...
Rights and Choices where Assign acts as a Processor: Certain Assign Services may be used by our customers to collect personal information about you. In such cases, we are processing such personal information purely on behalf of our customers and any individuals who seek to exercise their rights should first direct their query to our customer (the controller).
...
Children: Our Properties are not directed to individuals under the age of 16. We do not knowingly collect personal information from such individuals. If you become aware that a child has provided us with personal information, please contact us at privacy@Assign.com . If we become aware that a child under the age of 14 has provided us with personal information, we will take steps to delete such information.
...
External Links and Social Media Features: Our Properties may provide links to or the ability to connect with third party websites, services, social networks, applications or social media features such as "Share" or "Like" buttons. Visiting those sites or clicking on those links may allow the third party to collect and use information about you. Further, the personal information you choose to give to these third parties is not covered by this Privacy Notice. We encourage you to review the privacy notices and terms of use of such third parties prior to interacting with them or providing them with your personal information to understand how your information may be collected and used. Assign does not control the privacy practices of such third parties, nor do we endorse or make any representations about these third party websites, services, social networks or applications.

 

Do Not Track: Some Internet browsers - like Internet Explorer, Firefox, and Safari - include the ability to transmit "Do Not Track" or "DNT" signals. Since uniform standards for "DNT" signals have not been adopted, our online Properties do not currently process or respond to "DNT" signals. Assign takes privacy and meaningful choice seriously and will make efforts to continue to monitor developments around DNT browser technology and the implementation of a standard. To learn more about "DNT", please visit "All About Do Not Track".

 

Changes to this Privacy Notice: Assign will review and update this Privacy Notice periodically in response to changing legal, technical and business developments. When we update this Privacy Notice we will note the date of its most recent revision above. If we make material changes to this Privacy Notice, we will take appropriate measures to inform you in a manner that is consistent with the significance of the changes we make and is in accordance with applicable law. We encourage you to review this Privacy Notice frequently to be informed of how Assign is protecting your information.

PART IX: HOW TO CONTACT US 
If you have any questions or concerns regarding this Privacy Notice, you may write to us at privacy@Assign.com or by mail to: Office of the General Counsel of Assign, Inc., 3401 Hillview Ave, Palo Alto, California, 94304, USA.
    </div>
  )
}
