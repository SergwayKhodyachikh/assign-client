import RubricListScutch from './rubric-list-scutch.svg';
import RubricListChoose from './rubric-list-choose.svg';
import RubricListPhone from './rubric-list-phone.svg';
